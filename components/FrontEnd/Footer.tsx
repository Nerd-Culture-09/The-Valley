...
const Footer = () => {
  const footerNavs = [
    ...
    },
    {
      label: "Resources",
      items: [
        { href: "javascript:void()", name: "Contact", link: "/contact" }, // Updated Contact link
    ...
    },
    {
      label: "About",
      items: [
        { href: "javascript:void()", name: "Terms", link: "/terms" }, // Ensure the Terms link points to the Terms page
        { href: "javascript:void()", name: "About Us", link: "/about" }, // Ensure the About Us link points to the About page
      ],
    },
    {
      label: "Careers",
      items: [
        { href: "/careers", name: "Career" }, // Link updated to point to Careers page
      ],
    },
  ];
