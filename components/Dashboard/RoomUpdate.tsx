...
export default function RoomUpdate() {
    ...
    const handleUpdateAvailability = async (roomId: string, isAvailable: boolean) => {
                            ...
                            <AlertDialog>
                                ...
                                <AlertDialogContent>
                                    <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription>
                                            Click on Available to mark the room available for booking or Unavailable to
                                            mark the room unavailable for booking.
                                        </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
